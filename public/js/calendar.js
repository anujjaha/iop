...
function calendarJs( elementOrId, options, searchOptions ) {
    var _that = this,
        ...
        _element_Dialog_EventEditor_Title2 = null,
    ...
    function buildEventEditorEventTabContent() {
        ...
        _element_Dialog_EventEditor_Title.name = 'input-title';
        _element_Dialog_EventEditor_Title.classList.add("input-title");
    ...
    function showEventEditingDialog( eventDetails, overrideTodayDate, overrideTimeValues, originDayDate ) {
        ...
        // Not allowing to show dialog 
        // return true;
        console.log(eventDetails);
        if(eventDetails && eventDetails.id.length && eventDetails.id.length  < 5)
        {
            return ;
        }       

        
        console.log('---showEventEditingDialog---');
    ...
    function eventDialogEvent_Remove() {
        showEventEditorDisabledArea();
        console.log('--showEventEditorDisabledArea event--');
        ...
        var onYesEvent = function() {
            ...
            if ( isDefined( _element_Dialog_EventEditor_EventDetails.id ) ) {
                ...
                removeAjaxEvent(_element_Dialog_EventEditor_EventDetails);
    ...
    _that.removeEvent = function( id, updateEvents, triggerEvent ) {
        ...
        removeAjaxEventPopup(id, updateEvents, triggerEvent);
        var removed = false;
    ...
    function buildDefaulStringOptions() {
        ...
        _options.newEventDefaultTitle = getDefaultAnyString( _options.newEventDefaultTitle, "Exam" );
