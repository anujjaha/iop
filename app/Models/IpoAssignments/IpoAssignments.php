...
class IpoAssignments extends BaseModel
{
     ...
     */
    protected $fillable = [
        "alloted_date", "applied_date", "client_id", "created_at", "id", "ipo_id", "notes", "opening_rate", "profit_loss", "refund_date", "return_date", "revoked_date", "sell_date", "sell_price", "status", "updated_at", "share_qty", "share_profit_loss",
        "tax_amount",
        "profit_loss_aftertax"
    ];
