...
class AdminGiftController extends Controller
{
     ...
     * @var string
     */
    protected $createSuccessMessage = "Gift Created Successfully!";
     ...
     * @var string
     */
    protected $editSuccessMessage = "Gift Edited Successfully!";
     ...
     * @var string
     */
    protected $deleteSuccessMessage = "Gift Deleted Successfully";
